...
export default function ChambrePrestige() {
  const images = ["/medias/img/svg/chambre-standard-rect.svg", "/medias/img/svg/chambre-standard-rect.svg", "/medias/img/svg/chambre-standard-rect.svg"];
  const alts = ["", "", ""];
  return (
    <>
      <HeaderDefault></HeaderDefault>
      <main id="chambreStandard" className="relative pt-8 lg:pt-52 flex justify-center flex-col items-center min-h-[calc(100vh-208px)] mb-20">
        <Swiper
          // Swiper modules
